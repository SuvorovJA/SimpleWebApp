...
public class Utils {
	...
	// Store Connection in request attribute. Information stored only exist during
	// requests
	...
	// Store user info in Session. // On the JSP can access via ${LoggedUser}
	...
	public static void storeUserCookie(HttpServletResponse response, UserAccount user) {
		...
		cookieUserName.setMaxAge(24 * 60 * 60); // 1 day (Converted to seconds)
