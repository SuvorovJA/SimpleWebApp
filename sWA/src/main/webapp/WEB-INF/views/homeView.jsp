...
<body>
	...
	<ul>
		...
		<li>Использованы jsp, servlet, servlet filter &amp; jdbc</li>
		<li>Tomcat jdbc connection pool, с просмотром параметров пула из приложения</li>
		<li>Встроенная in-memory база данных H2 со ссылкой на  SQL консоль из приложения 
		<br>   для входа в консоль использовать JDBC URL: "jdbc:h2:mem:sWA", логин sa, пароля нет</li>
		<li>Инициализация базы через FlyWay</li>
		<li>Список организаций</li>
		<li>Создание новой организации</li>
		<li>Изменение и Удаление организации</li>
		<li>Поиск по справочнику организаций (регистрозависим)</li>
